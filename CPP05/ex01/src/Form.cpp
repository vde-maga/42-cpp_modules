...
Form::Form(void) :
    m_name("Default"), m_isSigned(false), m_gradeToSign(LOWEST_GRADE), m_gradeToExecute(LOWEST_GRADE)
{
    std::cout << BRIGHT_CYAN << "[Form] Default constructor called for " << m_name
        << RESET << std::endl;
}
...
{
    std::cout << BRIGHT_CYAN << "[Form] Copy constructor called for " << m_name
        << RESET << std::endl;
}

Form &Form::operator=(const Form &original)
{
    std::cout << BRIGHT_CYAN << "[Form] Assignment operator called for " << m_name
        << RESET << std::endl;
...
Form::~Form(void)
{
    std::cout << BRIGHT_RED << "[Form] Destructor called for " << m_name
        << RESET << std::endl;
}
    ...
    m_name(name), m_isSigned(false), m_gradeToSign(gradeToSign), m_gradeToExecute(gradeToExecute)
{
    ...
    std::cout << BRIGHT_CYAN << "[Form] Parameterized constructor called for " << m_name
        << RESET << std::endl;
}
...
{
    stream << "Form " << form.getName() << " [signed: " << (form.isSigned() ? "yes" : "no")

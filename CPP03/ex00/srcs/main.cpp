...
int main(void)
{
    ...
    std::cout << "Starting ClapTrap unit tests\n\n";
    ...
    // Test 1: Default Constructor
    {
        ...
        {
            std::cerr << "  -> Test Failed: Default Constructor\n";
            passed = false;
            all_passed = false;
        }
        if (passed)
    ...
    // Test 2: Parameterized Constructor
    {
        ...
        if (ct.getName() != "Bobby" || ct.getHitPoints() != 10
            || ct.getEnergyPoints() != 10 || ct.getAttackDamage() != 0)
        {
            std::cerr << "  -> Test Failed: Parameterized Constructor\n";
            passed = false;
            all_passed = false;
        }
        if (passed)
    ...
    // Test 3: Copy Constructor
    {
        ...
        {
            std::cerr << "  -> Test Failed: Copy Constructor\n";
            passed = false;
            all_passed = false;
        }
        if (passed)
    ...
    // Test 4: Assignment Operator
    {
        ...
        {
            std::cerr << "  -> Test Failed: Assignment Operator\n";
            passed = false;
            all_passed = false;
        }
        if (passed)
    ...
    // Test 5: Attack and Repair behavior
    {
        ...
        {
            std::cerr << "  -> Test Failed: Attack energy drain\n";
            passed = false;
            all_passed = false;
        }
    ...
    // Test 6: Take Damage and overkill
    {
        ...
        {
            std::cerr << "  -> Test Failed: Take Damage\n";
            passed = false;
            all_passed = false;
        }
        ...
        {
            std::cerr << "  -> Test Failed: Take Damage overkill\n";
            passed = false;
            all_passed = false;
        }
    ...
    // Test 7: Energy depletion after repeated attacks
    {
        ...
        {
            std::cerr << "  -> Test Failed: Energy depletion\n";
            passed = false;
            all_passed = false;
        }
    ...
    // Test 8: Actions when hit points are zero
    {
        ...
        if (ct.getHitPoints() != 0)
        {
            std::cerr << "  -> Test Failed: Hitpoints depletion\n";
            passed = false;
            all_passed = false;
        }
    ...
    {
        std::cout << "Some tests failed. See error messages above for details.\n";
    }
